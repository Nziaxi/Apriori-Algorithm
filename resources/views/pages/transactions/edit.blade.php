                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="transaction_date" class="form-control" id="transaction_date"
                                    placeholder="Masukkan Tanggal Transaksi" value="{{ $transaction->transaction_date }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="menu_code" id="menu_code" required>
                                    <option value="" disabled>Pilih Kode Menu</option>
                                    @foreach ($menus as $menu)
                                        <option value="{{ $menu->code }}"
                                            {{ $menu->code == $transaction->menu_code ? 'selected' : '' }}>
                                            {{ $menu->code }} - {{ $menu->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="quantity" class="form-control" id="quantity"
                                    placeholder="Masukkan Kuantitas" value="{{ $transaction->quantity }}">
                                @error('quantity')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="total_price" class="form-control" id="total_price"
                                    placeholder="Masukkan Total Harga" value="{{ $transaction->total_price }}">
                                @error('total_price')
